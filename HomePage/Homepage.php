        ...
        <section class="main-container">
            ...
            <div class="project-list">
                ...
                <button class="pressproject" id="ProjectOneButton">
                    ...
                    <div class="dd-mm-yyyy-group">
                      <div class="dd-mm-yyyy2">DD-MM-YYYY</div>
                      <div class="div1">-&gt;</div>
                      <div class="dd-mm-yyyy3">DD-MM-YYYY</div>
                    </div>
                    <div class="lorem-ipsum-dolor-sit-amet-co-container">
                      <div class="lorem-ipsum-dolor-container2">
                        <span class="lorem-ipsum-dolor-container3">
                ...
                <button class="pressproject" id="ProjectThreeButton">
                    <div class="pressproject-label">Project Three</div>
                    <div class="dd-mm-yyyy-group">
                        <div class="dd-mm-yyyy2">DD-MM-YYYY</div>
                        <div class="div1">-&gt;</div>
                        <div class="dd-mm-yyyy3">DD-MM-YYYY</div>
                ...
                <button class="pressproject" id="ProjectFourButton">
                    <div class="pressproject-label">Project Four</div>
                    <div class="dd-mm-yyyy-group">
                        <div class="dd-mm-yyyy2">DD-MM-YYYY</div>
                        <div class="div1">-&gt;</div>
                        <div class="dd-mm-yyyy3">DD-MM-YYYY</div>
                    ...
                    <div class="lorem-ipsum-dolor-sit-amet-co-container">
                        <div class="lorem-ipsum-dolor-container2">
                            <span class="lorem-ipsum-dolor-container3">
                                <p class="lorem-ipsum-dolor1">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            </span>
                        </div>
                    </div>
                    <div class="project-inner">
                ...
                <button class="pressproject" id="ProjectFiveButton">
                    <div class="pressproject-label">Project Five</div>
                    <div class="dd-mm-yyyy-group">
                        <div class="dd-mm-yyyy2">DD-MM-YYYY</div>
                        <div class="div1">-&gt;</div>
                        <div class="dd-mm-yyyy3">DD-MM-YYYY</div>
                ...
                <button class="pressproject" id="ProjectSixButton">
                    <div class="pressproject-label">Project Six</div>
                    <div class="dd-mm-yyyy-group">
                        <div class="dd-mm-yyyy2">DD-MM-YYYY</div>
                        <div class="div1">-&gt;</div>
                        <div class="dd-mm-yyyy3">DD-MM-YYYY</div>
